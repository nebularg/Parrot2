...
L_TriggerConditions_Data:AddTranslations("frFR", function() return {
		...
		["Incoming block"] = "Blocage par le joueur",
		["Incoming crit"] = "Critique sur le joueur",
		["Incoming dodge"] = "Esquive par le joueur",
		["Incoming parry"] = "Parade par le joueur",
		["Outgoing block"] = "Blocage par la cible",
		["Outgoing crit"] = "Critique sur la cible",
		["Outgoing dodge"] = "Esquive par la cible",
		["Outgoing parry"] = "Parade par la cible",
