...
--@localization(locale="zhCN", format="lua_additive_table", same-key-is-true=true, namespace="Parrot_TriggerConditions")@
...
--@localization(locale="zhCN", format="lua_additive_table", namespace="Parrot_PointGains")@
