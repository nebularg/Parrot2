...
local defaultTriggers = {
	[1004] = [[{
		-- Execute
		name = L["%s!"]:format(C_Spell.GetSpellName(5308)),
		icon = 5308,
		spec = { WARRIOR = "71;72", },
		conditions = {
			["Unit health"] = {
	...
	[1014] = [[{
		-- Revenge
		name = L["%s!"]:format(C_Spell.GetSpellName(6572)),
		icon = 6572,
		spec = { WARRIOR = "73" },
		conditions = {
			["Aura gain"] = {
				{
					spell = C_Spell.GetSpellInfo(5302),
					unit = "player",
					auraType = "BUFF",
				},
			},
	...
	[1017] = [[{
		-- Rime
		name = L["%s!"]:format(C_Spell.GetSpellName(59052)),
		icon = 59052,
		spec = { DEATHKNIGHT = "251" },
		conditions = {
			["Aura gain"] = {
				[1] = {
					spell = C_Spell.GetSpellInfo(59052),
					unit = "player",
					auraType = "BUFF",
				},
			},
	...
	[1018] = [[{
		-- Killing Machine
		name = L["%s!"]:format(C_Spell.GetSpellName(51124)),
		icon = 51124,
		spec = { DEATHKNIGHT = "251" },
		conditions = {
			["Aura gain"] = {
				[1] = {
					spell = C_Spell.GetSpellInfo(51124),
					unit = "player",
					auraType = "BUFF",
				},
			},
	...
	[1021] = [[{
		-- Brain Freeze
		name = L["%s!"]:format(C_Spell.GetSpellName(190447)),
		icon = 190447,
		spec = { MAGE = "64" },
		conditions = {
			["Aura gain"] = {
				[1] = {
					["unit"] = "player",
					["spell"] = C_Spell.GetSpellInfo(190447),
					["auraType"] = "BUFF",
				},
			},
		},
	...
	[1031] = [[{
		-- Fingers of Frost
		name = L["%s!"]:format(C_Spell.GetSpellName(44544)),
		icon = 44544,
		spec = { MAGE = "64" },
		conditions = {
			["Aura gain"] = {
				[1] = {
					["unit"] = "player",
					["spell"] = C_Spell.GetSpellInfo(44544),
					["auraType"] = "BUFF",
				},
			},
		},
	...
	[1033] = [[{
		-- Crimson Scourge
		name = L["%s!"]:format(C_Spell.GetSpellName(81141)),
		icon = 81141,
		...
		conditions = {
			["Aura gain"] = {
				[1] = {
					unit = "player",
					spell = C_Spell.GetSpellInfo(81141),
					auraType = "BUFF",
				},
			},
		},
	...
	[1041] = [[{
		-- Sudden Doom
		name = L["%s!"]:format(C_Spell.GetSpellName(81340)),
		icon = 81340,
		spec = { DEATHKNIGHT = "252" },
		conditions = {
			["Aura gain"] = {
				{
					spell = C_Spell.GetSpellInfo(81340),
					unit = "player",
					auraType = "BUFF",
				},
			},
	...
	[1043] = [[{
		-- Hot Streak!
		name = C_Spell.GetSpellName(48108),
		icon = 48108,
		spec = { MAGE = "63" },
		conditions = {
			["Aura gain"] = {
				{
					spell = C_Spell.GetSpellInfo(48108),
					unit = "player",
					auraType = "BUFF",
				},
			},
	...
	[1044] = [[{
		-- Heating Up
		name = L["%s!"]:format(C_Spell.GetSpellName(48107)),
		icon = 48107,
		spec = { MAGE = "63" },
		conditions = {
			["Aura gain"] = {
				{
					spell = C_Spell.GetSpellInfo(48107),
					unit = "player",
					auraType = "BUFF",
				},
			},
	...
	[1046] = [[{
		-- Grand Crusader
		name = L["%s!"]:format(C_Spell.GetSpellName(85416)),
		icon = 85416,
		spec = { PALADIN = "66" },
		conditions = {
			["Aura gain"] = {
				{
					spell = C_Spell.GetSpellInfo(85416),
					unit = "player",
					auraType = "BUFF",
				},
			},
	...
	[1047] = [[{
		-- Lava Surge
		name = L["%s!"]:format(C_Spell.GetSpellName(77756)),
		icon = 77756,
		spec = { SHAMAN = "262;264" },
		conditions = {
			["Aura gain"] = {
				{
					spell = C_Spell.GetSpellInfo(77756),
					unit = "player",
					auraType = "BUFF",
				},
			},
	...
	[1050] = [[{
		-- Raging Blow
		name = L["%s!"]:format(C_Spell.GetSpellName(85288)),
		icon = 85288,
		spec = { WARRIOR = "72" },
		conditions = {
			["Spell overlay"] = {
	...
	[1051] = [[{
		-- Sudden Death
		name = L["%s!"]:format(C_Spell.GetSpellName(280776)),
		icon = 280776,
		spec = { WARRIOR = "71;72" },
		conditions = {
			["Aura gain"] = {
				{
					spell = C_Spell.GetSpellInfo(280776),
					unit = "player",
					auraType = "BUFF",
				},
			},
	...
	[1052] = [[{
		-- Shield Slam
		name = L["%s!"]:format(C_Spell.GetSpellName(23922)),
		icon = 23922,
		spec = { WARRIOR = "73" },
		conditions = {
			["Spell overlay"] = {
	...
	[1053] = [[{
		-- Nightfall
		name = L["%s!"]:format(C_Spell.GetSpellName(108558)),
		icon = 108558,
		spec = { WARLOCK = "265" },
		conditions = {
			["Spell overlay"] = {
	...
	[1054] = [[{
		-- Lethal Shots
		name = L["%s!"]:format(C_Spell.GetSpellName(260395)),
		icon = 260395,
		spec = { HUNTER = "254" },
		conditions = {
			["Aura gain"] = {
				{
					spell = C_Spell.GetSpellInfo(260395),
					unit = "player",
					auraType = "BUFF",
				},
			},
	...
	[1055] = [[{
		-- Lock and Load
		name = L["%s!"]:format(C_Spell.GetSpellName(194594)),
		icon = 194594,
		spec = { HUNTER = "254" },
		conditions = {
			["Aura gain"] = {
				{
					spell = C_Spell.GetSpellInfo(194594),
					unit = "player",
					auraType = "BUFF",
				},
			},
	...
	[1056] = [[{
		-- Kill Command
		name = L["%s!"]:format(C_Spell.GetSpellName(259489)),
		icon = 259489,
		spec = { HUNTER = "255" },
		conditions = {
			["Spell overlay"] = {
	...
	[1057] = [[{
		-- Viper's Venom
		name = L["%s!"]:format(C_Spell.GetSpellName(268552)),
		icon = 268423,
		spec = { HUNTER = "255" },
		conditions = {
			["Aura gain"] = {
				{
					spell = C_Spell.GetSpellInfo(268552),
					unit = "player",
					auraType = "BUFF",
				},
			},
	...
	[1058] = [[{
		-- Clearcasting
		name = L["%s!"]:format(C_Spell.GetSpellName(16870)),
		icon = 16870,
		spec = {
			DRUID = "103;105",
			MAGE = "62",
		...
		conditions = {
			["Aura gain"] = {
				{
					spell = C_Spell.GetSpellInfo(16870),
					unit = "player",
					auraType = "BUFF",
				},
			},
	...
	[1059] = [[{
		-- Gore
		name = L["%s!"]:format(C_Spell.GetSpellName(93622)),
		icon = 33917,
		spec = { DRUID = "104" },
		conditions = {
			["Aura gain"] = {
				{
					spell = C_Spell.GetSpellInfo(93622),
					unit = "player",
					auraType = "BUFF",
				},
			},
	...
	[1060] = [[{
		-- Galatic Guardian
		name = L["%s!"]:format(C_Spell.GetSpellName(213708)),
		icon = 8921,
		spec = { DRUID = "104" },
		conditions = {
			["Aura gain"] = {
				{
					spell = C_Spell.GetSpellInfo(213708),
					unit = "player",
					auraType = "BUFF",
				},
			},
	...
	[1061] = [[{
		...
		name = L["%s!"]:format(C_Spell.GetSpellName(198069)),
		icon = 198069,
		spec = { PRIEST = "256" },
		conditions = {
			["Aura gain"] = {
				{
					spell = C_Spell.GetSpellInfo(198069),
					unit = "player",
					auraType = "BUFF",
				},
			},
	...
	[1062] = [[{
		-- Surge of Light
		name = L["%s!"]:format(C_Spell.GetSpellName(114255)),
		icon = 114255,
		spec = { PRIEST = "257" },
		conditions = {
			["Aura gain"] = {
				{
					spell = C_Spell.GetSpellInfo(114255),
					unit = "player",
					auraType = "BUFF",
				},
			},
	...
	[1063] = [[{
		-- Divine Purpose
		name = L["%s!"]:format(C_Spell.GetSpellName(223817)),
		icon = 223817,
		spec = { PALADIN = "65;70" },
		conditions = {
			["Aura gain"] = {
				{
					spell = C_Spell.GetSpellInfo(223817),
					unit = "player",
					auraType = "BUFF",
				},
			},
	...
	[1064] = [[{
		-- Stormbringer
		name = C_Spell.GetSpellName(201846),
		icon = 17364,
		spec = { SHAMAN = "263" },
		conditions = {
			["Aura gain"] = {
				{
					spell = C_Spell.GetSpellInfo(201846),
					unit = "player",
					auraType = "BUFF",
				},
			},
	...
	[1065] = [[{
		-- Opportunity
		name = C_Spell.GetSpellName(195627),
		icon = 195627,
		spec = { ROGUE = "260" },
		conditions = {
			["Aura gain"] = {
				{
					spell = C_Spell.GetSpellInfo(195627),
					unit = "player",
					auraType = "BUFF",
				},
			},
	...
	[1066] = [[{
		-- Blackout Kick!
		name = C_Spell.GetSpellName(116768),
		icon = 116768,
		spec = { MONK = "269" },
		conditions = {
			["Aura gain"] = {
				{
					spell = C_Spell.GetSpellInfo(116768),
					unit = "player",
					auraType = "BUFF",
				},
			},
